...
import net.oleksin.service.ObservationsBySeriesDataPreparationService;
...
class ObservationsBySeriesDataPreparationServiceTest {
    private static ObservationsBySeriesDataPreparationService service;
    ...
    static void beforeAll() {
        ...
        service = new ObservationsBySeriesDataPreparationService(csvRowConverter, observationsBySeriesDataConverter, changeCounterService);
    }
